...
aggravateFish = {"list": [
    ...
    Swap(0, 5),
    Burst(0, 5.4),
    Normal(0, 7.28, 3, charged=True),
    Normal(0, 9.43, 3, charged=True),
    Normal(0, 11.58, 3, charged=True),
    Normal(0, 13.73, 1, charged=True),
    Swap(2, 15.8),
    ...
    Swap(0, 24.27),
    Burst(0, 24.67),
    Normal(0, 26.55, 3, charged=True),
    Normal(0, 28.7, 3, charged=True),
    Normal(0, 30.85, 3, charged=True),
    Normal(0, 33, 1),
    Swap(2, 35.07),
...
Test = {"list": [
    ...
    Skill(2, 0.95, infusion=Element.ELECTRO),
    Swap(1, 2.13),
    Skill(1, 2.32),
    Burst(1, 3.32),
    Swap(3, 4.18),
    ...
    Swap(0, 7),
    Burst(0, 7.167),
    Normal(0, 9.05, 3, charged=True),
    Normal(0, 11.2, 3, charged=True),
    Normal(0, 13.35, 3, charged=True),
    Normal(0, 15.5, 1, charged=True),
    Swap(3, 17.8),
    Charged(3, 17.95),
    Skill(3, 18.5),
    Swap(2, 18.98),
    ...
    Swap(0, 26.517),
    Burst(0, 26.7),
    Normal(0, 28.58, 3, charged=True),
    Normal(0, 30.73, 3, charged=True),
    Normal(0, 32.88, 3, charged=True),
    Normal(0, 35.03, 1, charged=True),
    Swap(2, 37.41),
...
Taser = {"list":
             [
                ...
                Normal(3, 9.567, 2),
                Reaction(3, 9.7, reaction=Reactions.HYDROSWIRL),
                Skill(3, 10.15),
                Reaction(3, 10.45, reaction=Reactions.HYDROSWIRL),
                Normal(3, 11.367, 2),
                Normal(3, 12.633, 2),
                Skill(3, 13.3),
                Reaction(3, 13.5, reaction=Reactions.HYDROSWIRL),
                Swap(1, 14.617),
                Charged(1, 14.983),
                Skill(1, 15.417),
                Swap(0, 16.35),
