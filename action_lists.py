...
aggravateFish = {"list": [Skill(0, 0),
                    Swap(2, 0.62),
                    Skill(2, 0.85, infusion=Element.ELECTRO),
                    SetAura(0, 1.5, Aura.QUICKEN),
                    Swap(1, 1.9),
                    #Skill(1, 2.13),
                    #Burst(1, 2.85),
                    Swap(3, 3.72),
                    ...
                    Burst(3, 4.58),
                    Swap(2, 5),
                    Burst(2, 5.23, infusion=Element.ELECTRO),
                    Swap(0, 6.83),
                    Burst(0, 7.07),
                    Normal(0, 8.93, 3),
                    Normal(0, 11.08, 3),
                    ...
                    Skill(3, 15.6),
                    Swap(2, 16.6),
                    Skill(2, 16.83, infusion=Element.ELECTRO),
                    Normal(3, 18, 3),
                    Swap(0, 18.95),
                    Skill(0, 19.18),
                    Normal(0, 20.05, 1),
                    ...
                    Burst(3, 22.75),
                    Swap(2, 23.15),
                    Skill(2, 23.4, infusion=Element.ELECTRO),
                    Burst(2, 24.45, infusion=Element.ELECTRO),
                    Swap(0, 26.05),
                    Burst(0, 26.28),
                    Normal(0, 28.15, 3),
                    Normal(0, 30.3, 3),
                    Normal(0, 32.45, 3),
                    Swap(2, 34.15),
                    Skill(2, 34.82, infusion=Element.ELECTRO),
                    Swap(0, 35.87)],
           "length": 36}
